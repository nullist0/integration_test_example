...
$adb_path uninstall "com.example.flutter.integration.integration_test_example"
...
$adb_path shell "
am start -n com.example.flutter.integration.integration_test_example/.MainActivity
exit
"
